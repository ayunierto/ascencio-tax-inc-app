  ...
  const staff = [
    {
      name: 'Lucy Ascencio',
      role: 'Tax Associates',
      image: 'https://static.wixstatic.com/media/aa0f39_4a2ce08d9cd746b69b5c9f1aabd5aced~mv2.jpg',
    ...
    },
    {
      name: 'Yulier Rondon',
      role: 'Tax Associates',
      image: 'https://static.wixstatic.com/media/aa0f39_97050a158da5419ebf9284baa30a4ec9~mv2.jpg',
      facebook: 'https://www.facebook.com/ascenciotaxinc',
      instagram: 'https://www.instagram.com/ascenciotax/',
      whatsapp: '+14166581208',
    },
    {
      ...
      image: 'https://static.wixstatic.com/media/5b9531_93df9e8ed20f46bd97ceba5166d91d9d~mv2.jpeg',
      facebook: 'https://www.facebook.com/ascenciotaxinc',
      instagram: 'https://www.instagram.com/ascenciotax/',
      whatsapp: '+14166581208',
    },
    ...
    <View style={styles.page}>
      ...
      >
        <View style={styles.heroCard}>
          <Text style={[styles.heroTitle, { color: theme.foreground }]}>{t('letsChat')}</Text>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            >
              ...
              <Text style={[styles.quickActionText, { color: theme.foreground }]}>{t('call')}</Text>
            </Pressable>
            ...
            >
              ...
              <Text style={[styles.quickActionText, { color: theme.foreground }]}>
                {t('email')}
              </Text>
            </Pressable>
            ...
            >
              ...
              <Text style={[styles.quickActionText, { color: theme.foreground }]}>{t('maps')}</Text>
            </Pressable>
          </View>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.socialRow}>
            <Pressable
              ...
              accessibilityRole='button'
            >
              <Ionicons name='logo-facebook' size={20} color={theme.foreground} />
            </Pressable>
            <Pressable
              ...
              accessibilityRole='button'
            >
              <Ionicons name='logo-instagram' size={20} color={theme.foreground} />
            </Pressable>
            <Pressable
              ...
              accessibilityRole='button'
            >
              <Ionicons name='logo-whatsapp' size={20} color={theme.foreground} />
            </Pressable>
          </View>
        </View>

        <View style={styles.teamContainer}>
          <Text style={[styles.sectionTitle, { color: theme.primary }]}>{t('ourTeam')}</Text>

          {staff.map((m) => (
            <View key={m.name} style={styles.memberCard}>
              <Image source={{ uri: m.image }} style={styles.memberImage} />
              <View style={styles.memberContent}>
                <Text style={[styles.memberName, { color: theme.foreground }]}>{m.name}</Text>
                <Text style={[styles.memberRole, { color: theme.muted }]}>{m.role}</Text>
                <View style={styles.memberActions}>
                  <Pressable onPress={() => openUrl(m.facebook)} style={styles.memberIconButton}>
                    <Ionicons name='logo-facebook' size={18} color={theme.foreground} />
                  </Pressable>
                  <Pressable onPress={() => openUrl(m.instagram)} style={styles.memberIconButton}>
                  ...
                  >
                    <Ionicons name='logo-whatsapp' size={18} color={theme.foreground} />
                  </Pressable>
                </View>
              </View>
            </View>
