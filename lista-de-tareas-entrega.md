...
- Copiar Web Client ID a `EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID`.
...
- Activar Crashlytics y Analytics en Firebase.
- Configurar CI/CD para builds de release (EAS/GitHub Actions).
